...
export const NEW_PRODUCTS = '/new-products';
export const RECOMMENDED_PRODUCTS = '/recommended';
export const CATEGORY_PRODUCTS = '/category/:categoryId/:categoryName';
export const LEGACY_CATEGORY_PRODUCTS = '/category/:categoryName';
